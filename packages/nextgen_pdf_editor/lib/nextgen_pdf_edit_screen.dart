...
class _OPdfEditScreenState extends State<NGPdfEditScreen> {
  ...
  /// Flag to manage the zoom mode state.
  ...
  /// When exiting zoom mode, the scale is reset to 1.0 to ensure drawing coordinates map correctly.
      ...
      child: Row(
        ...
        children: [
          ...
          _buildUndoRedoButton(
            ...
            onPressed: () {
              setState(() {
                _isZoomMode = false; // Reset zoom state
                _selectedIndex = -1;
  ...
  Widget _buildBottomNavItem(IconData icon, String label, int index) {
    ...
    return Expanded(
      child: GestureDetector(
        onTap: () {
          setState(() {
            _isZoomMode = false; // Reset zoom state when switching tools
            if (isSelected) {
