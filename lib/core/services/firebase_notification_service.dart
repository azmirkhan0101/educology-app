...
class FirebaseNotificationService {
  ...
  Future<void> initialize() async {
    try {
      ...
      await _configureForegroundPresentation(); // <- Added to prevent native double popups
  ...
  /// Force Firebase to turn off native popups when app is open (Prevents duplication)
  Future<void> _configureForegroundPresentation() async {
    await _firebaseMessaging.setForegroundNotificationPresentationOptions(
      alert: false, // Turn off native OS alerts in foreground so local notifications can control it
      badge: true,
      sound: true,
    );
  }
  ...
  Future<void> _initializeLocalNotifications() async {
    // Uses your clean, designated monochrome notification drawable
    ...
    // Correct parameter syntax passing for initialization
  ...
  Future<void> _showLocalNotification(RemoteMessage message) async {
    const androidDetails = AndroidNotificationDetails(
      ...
      showWhen: true,
      icon: 'ic_stat_notification', // <- Fixed: Use the modern status icon resource, not launcher
    );
  ...
  void _navigateBasedOnPayload(Map<String, dynamic> data) {
    ...
    debugPrint('Notification payload navigation destination - route: $route');
...
Future<void> firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  debugPrint('Background message logged: ${message.messageId}');
  // System takes absolute ownership of drawing background banners. Do not invoke local plugins here.
}
...
//
//   if (message.notification != null) {
//     // The Firebase SDK / OS will handle showing this automatically.
